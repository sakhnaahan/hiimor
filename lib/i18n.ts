...
export const translations = {
  ...
  mn: {
    ...
    winPays: "Таавал төлөх",
    watchLive: "Шууд үзэх",
    race: "Уралдаан",
    chooseHorseAndBet: "HKJC морь сонгож таавар тавих",
    ...
    ifYouWin: "Таавал авах",
    betAmount: "Тааварын дүн",
    enterBetAmount: "Тааварын дүн оруулах",
    max: "Бүгд",
    clear: "Арилгах",
    placeBet: "Баталгаажуулах",
    openBetslip: "Таавар",
    hideBetslip: "Хаах ",
    betSlip: "Тааварны сагс",
    basket: "Сагс",
    addToBetSlip: "Нэмэх",
    noOfBets: "Таавар тоо",
    totalNoOfBets: "Нийт таавар тоо",
    unitBet: "",
    betTotal: "Нийт",
    totalAmount: "Нийт дүн",
    betTypeText: "Таавар төрөл",
    removeBet: "Таавар устгах",
    emptyBetSlip: "Одоогоор сонгосон таавар байхгүй байна.",
    placeBasketConfirm: "{amount} дүнтэй {count} таавар  тавих уу?",
    placing: "Тавьж байна...",
    placeBetConfirm:
      "{amount} коиноор No. {horseNo} {horseName} дээр таавар тавих уу?",
    ...
    pendingBetsAdmin: "Хариу хүлээгдэж буй таавар",
    todayBetVolume: "Өнөөдрийн тааврын дүн",
    ...
    closeMenu: "Цэс хаах",
    adminRaceViewOnly:
      "Админ зөвхөн харах боломжтой. Тоглогчийн таавар идэвхгүй.",
...
const serverMessageTranslations: Record<string, string> = {
  ...
  "Invalid race bet.": "Тааврын мэдээлэл буруу байна.",
  ...
  "Race failed.": "Таавар тавихад алдаа гарлаа.",
